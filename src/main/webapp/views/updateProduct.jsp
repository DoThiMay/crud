...
<body>
	<p>
		Do you really want to assign product: <strong>${product.getProductName()}
	...
	<form:form method="POST"
		...
		<form:input type="text" value="${product.getProductName()}"
			placeholder="Enter product's name" path="productName" />
		<br/>
		<form:errors path="productName" cssClass="error"/> <br>
		<form:input type="number" value="${product.getPrice()}"
			placeholder="Enter product's price" path="price" />
		<br/>
		<form:errors path="price" cssClass="error"/> <br>
		<form:input type="text" value="${product.getDescription()}"
